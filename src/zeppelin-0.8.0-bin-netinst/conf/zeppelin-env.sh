...
export ZEPPELIN_MEM="-Xms1g -Xmx3g -XX:MaxPermSize=512m"
# zeppelin interpreter process jvm mem options. Default -Xms1024m -Xmx1024m -XX:MaxPermSize=512m
export ZEPPELIN_INTP_MEM="-Xms1g -Xmx3g -XX:MaxPermSize=512m"
export ZEPPELIN_JAVA_OPTS="-Djavax.net.ssl.trustStore=/opt/zeppelin/spark-zeppelin/conf/truststore.jks -Djavax.net.ssl.trustStoreType=jks -Djavax.net.ssl.trustStorePassword=Aut0m4t#"
